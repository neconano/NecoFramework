...
class Admin extends Controller
{
    ...
    {
        $index_count['module'] = D2('AdminModule')->count();
        $index_count['addon']  = D2('AdminAddon')->count();
        $index_count['users']  = D2('AdminUser')->count();
        ...
        $index_count['today'] = D2('AdminUser')->where($map)->count();
